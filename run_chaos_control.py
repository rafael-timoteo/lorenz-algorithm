...
from lorenz_solver import runge_kutta_4th_order_solver, lorenz_system_equations
# Importa a nova função de controle
from chaos_control import lorenz_controlled_system_x
