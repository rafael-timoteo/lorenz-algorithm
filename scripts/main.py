...
from core.lorenz_solver import lorenz_system_equations, runge_kutta_4th_order_solver
from visualization.attractor_generator import plot_and_save_attractor
from visualization.timeseries_generator import plot_and_save_timeseries
from analysis.lyapunov import LyapunovExponents
from analysis.fractal_dimension_kaplan_yorke import FractalDimension

# Para Abordagem 1: Seções de Poincaré Individuais
from visualization.poincare_sections import plot_and_save_poincare_section 

# Para Abordagem 2: Novas Imagens de Seções de Poincaré (1x3 subplots)
from visualization.poincare_sections_grad import ( 
...
from analysis.fractal_dimension import box_counting_dimension
